...
The `src/cli/` directory provides the command-line interface for installing and configuring **miya**, an OpenCode plugin. It handles:
...
| `miya.json` | `~/.config/opencode/` | Plugin-specific config |
