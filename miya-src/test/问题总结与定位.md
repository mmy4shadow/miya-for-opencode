...
3. 覆盖率脚本 reporter 不兼容 Node/Vitest
...
- `npm run test:ci`
- `npx vitest run test/unit/automation-service.test.ts --timeout 30000`
- `npx vitest run test/unit/multi-agent-orchestration.test.ts test/unit/memory-system-architecture.test.ts test/unit/training-pipeline-integrity.test.ts --timeout 30000`
- `npx vitest run test/unit/automation-service.test.ts test/unit/gateway-method-domain-separation.test.ts --timeout 60000`
- `npx vitest run test/unit/channel-policy-hardening.test.ts --timeout 60000`
- `npx vitest run test/unit/channel-policy-hardening.test.ts src/channels/service.test.ts src/policy/index.test.ts --timeout 60000`
