import { getSessionState, isNegativeConfirmation, resetSessionState, setSessionState, shouldEnableStrictQualityGate, } from '../../workflow';
...
export function createLoopGuardHook(projectDir) {
    return {
        'experimental.chat.messages.transform': async (_input, output) => {
            ...
            if (lowered.includes('strict-quality-gate off') ||
