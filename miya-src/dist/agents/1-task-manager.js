...
- If \`miya_iteration_done\` returns MIYA_LOOP_LIMIT_REACHED=true or MIYA_LOOP_STALLED=true, do not ask user for approval.
- When loop limit is reached or stalled, close with degraded completion or hard failure replay pack.
</Default Runtime>
...
export function createOrchestratorAgent(model, customPrompt, customAppendPrompt) {
