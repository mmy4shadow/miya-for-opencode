...
export declare function removePersistedAgentRuntimeSelection(projectDir: string, agentName: string, options?: {
    clearActive?: boolean;
    activeAgentId?: string;
}): boolean;
...
export declare function persistAgentRuntimeFromConfigSnapshot(projectDir: string, snapshot: unknown): {
    updated: number;
    activeAgentId?: string;
};
