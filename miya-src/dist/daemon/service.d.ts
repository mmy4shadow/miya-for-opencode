...
import { type PsycheConsultRequest, type PsycheConsultResult, type PsycheOutcomeRequest, type PsycheOutcomeResult } from './psyche';
...
export declare class MiyaDaemonService {
    ...
    private runBuiltinTrainingRunner;
