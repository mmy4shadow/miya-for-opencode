...
import { KillSwitchMode } from '../types/gateway';
...
const QuickStats = React.memo<QuickStatsProps>(function QuickStats({
  ...
  ], [connected, sessions.active, sessions.total, jobs.enabled, jobs.total, nexus.pendingTickets]);
...
const SystemStatusCard = React.memo<SystemStatusCardProps>(function SystemStatusCard({
  connected,
  cpuPercent,
  memoryMB,
  activeAgentId,
