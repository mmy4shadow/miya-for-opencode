    ...
    <Card title="守门员状态" subtitle="Psyche Signal Hub">
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className={`text-sm font-medium ${hub?.running ? 'text-green-600' : 'text-slate-400'}`}>
            {hub?.running ? '运行中' : '离线'}
          </span>
        </div>
        ...
        {hub?.sampledAt && (
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm">{new Date(hub.sampledAt).toLocaleString()}</span>
          </div>
        )}
        ...
        {guardianSafeHoldReason && (
          <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <div className="text-xs font-medium text-amber-800 mb-1">安全保持原因</div>
            <div className="text-sm text-amber-700">{guardianSafeHoldReason}</div>
          </div>
        )}
      </div>
    </Card>
  ...
  return (
    <Card title="Psyche 配置" subtitle="交互感知参数设置">
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="resonanceEnabled" className="text-sm font-medium text-slate-700">
            共鸣层
          </label>
          <input
            id="resonanceEnabled"
            ...
            onChange={(e) => setFormData({ ...formData, resonanceEnabled: e.target.checked })}
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="captureProbeEnabled" className="text-sm font-medium text-slate-700">
            捕获探针
          </label>
          <input
            ...
            onChange={(e) => setFormData({ ...formData, captureProbeEnabled: e.target.checked })}
            className="h-4 w-4 rounded border-slate-300"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="signalOverrideEnabled" className="text-sm font-medium text-slate-700">
            信号覆盖
          </label>
          <input
            ...
            onChange={(e) => setFormData({ ...formData, signalOverrideEnabled: e.target.checked })}
            className="h-4 w-4 rounded border-slate-300"
          />
        </div>
        ...
        <div className="space-y-2">
          <label htmlFor="proactivityExploreRate" className="text-sm font-medium text-slate-700">
          ...
          <input
            ...
            onChange={(e) => setFormData({ ...formData, proactivityExploreRate: parseInt(e.target.value) })}
            className="w-full"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="slowBrainEnabled" className="text-sm font-medium text-slate-700">
            慢脑
          </label>
          <input
            id="slowBrainEnabled"
            ...
            onChange={(e) => setFormData({ ...formData, slowBrainEnabled: e.target.checked })}
            className="h-4 w-4 rounded border-slate-300"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="slowBrainShadowEnabled" className="text-sm font-medium text-slate-700">
            慢脑影子模式
          </label>
          <input
            ...
            onChange={(e) => setFormData({ ...formData, slowBrainShadowEnabled: e.target.checked })}
            className="h-4 w-4 rounded border-slate-300"
          />
        </div>
        ...
        <div className="space-y-2">
          <label htmlFor="slowBrainShadowRollout" className="text-sm font-medium text-slate-700">
          ...
          <input
            ...
            onChange={(e) => setFormData({ ...formData, slowBrainShadowRollout: parseInt(e.target.value) })}
            className="w-full"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="periodicRetrainEnabled" className="text-sm font-medium text-slate-700">
            周期重训
          </label>
          <input
            ...
            onChange={(e) => setFormData({ ...formData, periodicRetrainEnabled: e.target.checked })}
            className="h-4 w-4 rounded border-slate-300"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          <label htmlFor="proactivePingEnabled" className="text-sm font-medium text-slate-700">
            主动触达
          </label>
          <input
            ...
            onChange={(e) => setFormData({ ...formData, proactivePingEnabled: e.target.checked })}
            className="h-4 w-4 rounded border-slate-300"
          />
        </div>
        ...
        <div className="space-y-3 pl-4 border-l-2 border-slate-200">
          <div className="space-y-1">
            <label htmlFor="proactivePingMinIntervalMinutes" className="text-sm font-medium text-slate-700">
              最小间隔（分钟）
            </label>
            <input
              ...
              onChange={(e) => setFormData({ ...formData, proactivePingMinIntervalMinutes: parseInt(e.target.value) })}
              className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm"
            />
          </div>
          <div className="space-y-1">
            <label htmlFor="proactivePingMaxPerDay" className="text-sm font-medium text-slate-700">
              每日最大次数
            </label>
            <input
              ...
              onChange={(e) => setFormData({ ...formData, proactivePingMaxPerDay: parseInt(e.target.value) })}
              className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm"
            />
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <label htmlFor="quietHoursEnabled" className="text-sm font-medium text-slate-700">
              静默时段
            </label>
            <input
          ...
          <div className="pl-4 border-l-2 border-slate-200 space-y-3">
            <div className="space-y-1">
              <label htmlFor="quietHoursStart" className="text-sm font-medium text-slate-700">
                起始时间
              </label>
              <input
                id="quietHoursStart"
            ...
            <div className="space-y-1">
              <label htmlFor="quietHoursEnd" className="text-sm font-medium text-slate-700">
                结束时间
              </label>
              <input
                id="quietHoursEnd"
            ...
            <div className="space-y-1">
              <label htmlFor="quietHoursTimezoneOffset" className="text-sm font-medium text-slate-700">
                时区偏移（小时）
              </label>
              <input
                ...
                onChange={(e) => setFormData({ ...formData, quietHoursTimezoneOffset: parseInt(e.target.value) })}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm"
              />
            </div>
          </div>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <PsycheSignalHubCard hub={hub} guardianSafeHoldReason={guardianSafeHoldReason} />
